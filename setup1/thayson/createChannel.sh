...
createChannel(){
    ...
    peer channel create -o 35.197.12.100:7050 -c $CHANNEL_NAME \
...
updateAnchorPeers(){
    setGlobalsForPeer0thayson
    peer channel update -o 35.197.12.100:7050 --ordererTLSHostnameOverride orderer.thesis.com -c $CHANNEL_NAME -f \
